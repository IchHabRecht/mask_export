...
class ExportControllerTest extends AbstractExportControllerTestCase
{
    ...
    {
        $this->assertArrayHasKey('Configuration/PageTSconfig/NewContentElementWizard.typoscript', $this->files);
        $this->assertNotContains(
            'CType = maskexampleexport_hidden-element',
            $this->files['Configuration/PageTSconfig/NewContentElementWizard.typoscript']
        );
    }
}
